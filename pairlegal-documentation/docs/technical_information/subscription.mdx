...
During the subscription process, you will specify the number of seats needed - this
determines how many team users can be added to your subscription.

## Adding Users to Subscription

After completing your payment, you will need to allocate seats to specific team users.
...
added as a user under the license. If you intend to use SingleDraft yourself, remember
to allocate one of the seats to your own account when managing team access.
