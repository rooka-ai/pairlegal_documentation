...
- Requires connecting your internal files first (see [Internal Data Synchronization](/docs/settings/integrations))

## How to Use Definition Tracking

### View Definitions

You can view definitions in two ways:
...
:::tip Word Forms
SingleDraft recognizes different forms and declensions of the same word. For example,
