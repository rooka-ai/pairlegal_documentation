...
As a [Team Admin](user_management/administrators.mdx#team-admin), you can add API keys
...
| ----------------- | ----------- | ------- | ---------------------- |
| GPT-4o            | Azure       | EU      |                        |
| GPT-4o mini       | Azure       | EU      | Unlimited tokens       |
| Claude 3.5 Sonnet | AWS Bedrock | EU      |                        |
| o3-mini           | AWS Bedrock | EU      | Thinking model         |
| DeepL             | DeepL       | EU      | Using your own API key |

See our [Security](/docs/settings/security) page for more information on how we handle
your data. In short, no data is being used for training or improving the models and
data are processed within the EU.
